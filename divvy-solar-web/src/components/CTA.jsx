    ...
    return (
        <section className="relative h-[300px] w-full bg-[color:var(--color-secondary)] overflow-hidden flex items-center">
            ...
            <div className="container mx-auto px-4 md:px-8 relative z-10 flex flex-col md:flex-row justify-between items-center">
                ...
                <a className="bg-[#1a1f3c] border border-gray-600 hover:bg-[color:var(--color-primary)] hover:text-[#1a1f3c] hover:border-[color:var(--color-primary)] text-white font-bold py-3 px-8 rounded-full transition duration-300 text-sm uppercase tracking-wider" href="#">
                    Consult Now
                </a>
            </div>
        </section>
